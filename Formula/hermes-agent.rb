class HermesAgent < Formula
  ...
  url "https://github.com/paullesiak/hermes-agent/archive/refs/tags/v2026.6.12-paul.2.tar.gz"
  version "2026.6.12-paul.2"
  sha256 "3c862f3e390a6caa5614f0e4dfb04977510ddf137347f83aaf35f031be85516b"
  license "MIT"
  head "https://github.com/paullesiak/hermes-agent.git", branch: "main"
  ...
  # Resource list generated from the fork with:
  #   uv export --extra mcp --extra web --extra acp --extra cli --no-dev --no-hashes
  # Excludes packages supplied by Homebrew formula dependencies:
  #   cryptography/cffi/pycparser, pillow, pydantic/pydantic-core/annotated-types.
  ...
  test do
    assert_match "Hermes Agent v0.16.0 (2026.6.5)", shell_output("#{bin}/hermes version")
    ...
    system libexec/"bin/python", "-c", <<~PY
      ...
      tui_entry = pathlib.Path(hermes_cli.__file__).parent / "tui_dist" / "entry.js"
